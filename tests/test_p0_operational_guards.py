...
class BridgeEntrypointTests(unittest.TestCase):
    ...
    def test_bridge_limits_option_chains_with_dynamic_underlying_universe(self):
        ...
        self.assertIn("6 if DAILY_RADAR_FAST else 10", source)
    ...
    def test_ibkr_account_selector_has_local_web_flow_without_printing_ids(self):
        ...
        self.assertIn("Refresh IBKR en curso", source)
        ...
        self.assertIn("Usar cuenta</button>", source)
        ...
        self.assertIn("Actualizar estado</strong> solo relee GPT/alertas", source)
